	...
	public ControlleurLivre() {
		...
		public String createAndShowLivre(Map<String,Object> param,
				...
				if(!titre.matches("[A-Za-z]")){
					param.put("OK",	this.bibliomanager.addLivre(titre, nombreDePages, dateDeParution, idCollection, numeroEdition, auteurs));
		...
		public String delLivres( Map<String,Object> param,@org.springframework.web.bind.annotation.RequestParam("ID") String code, @org.springframework.web.bind.annotation.RequestParam("DELETE") boolean del){
