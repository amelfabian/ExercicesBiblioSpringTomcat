...
public class ControlleurAuteurs {
	...
	public String createAndShowAuteurs(Map<String, Object> attribut,
			@org.springframework.web.bind.annotation.RequestParam("AUTEUR_PRENOM") String prenom,
			@org.springframework.web.bind.annotation.RequestParam("AUTEUR_NOM") String nom) {
	...
	public String delAuteur(@org.springframework.web.bind.annotation.RequestParam("ID") String code,
			@org.springframework.web.bind.annotation.RequestParam("DELETE") boolean del, Map<String, Object> param) {
